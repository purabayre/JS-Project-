...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // when 0 sec, stop time and logout user
    if (time === 0) {
      clearInterval(timer);
      labelWelcome.textContent = 'You are Logged out ,Log in to get started';
...
// console.log(Math.max(5, 18, '23', 11, 2));
// console.log(Math.sqrt(5, 18, '23px', 11, 2));
...
// console.log(6846000000000000000000);

// const now = new Date();
// console.log(now);

// console.log(new Date('Thu Jan 22 2026 17:23:10'));
// console.log(new Date(account1.movementsDates[0]));

// console.log(new Date(2026, 8, 16, 15, 23, 5));
...
// calcdaysPassed(new Date(2037, 3, 14), new Date(2037, 3, ));
...
//   clearTimeout(timer);
//   console.log('your pizza have spinach');
// }
